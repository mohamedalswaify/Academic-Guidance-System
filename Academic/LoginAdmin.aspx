<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginAdmin.aspx.cs" Inherits="Academic.LoginAdmin" %>
                                ...
                                <div class="col-md-6 col-lg-7 d-flex align-items-center ">
                                    <div class="card-body p-4 p-lg-5 text-black text-end">
                                        <form id="form1" runat="server">
                                            ...
                                            <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">تسجيل الدخول الى لوحة التحكم</h5>
                                            ...
                                            <div class="pt-1 mb-4">
                                                <asp:Button ID="btnLoginAdmin" runat="server" Text=" تسجيل دخول"  class="btn w-100 btn-danger btn-lg btn-block" OnClick="btnLoginAdmin_Click" />
                                            </div>
                                        </form>
