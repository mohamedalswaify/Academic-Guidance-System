...
{
    public partial class Page_Advisor4 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            tbl = db.SqlQuery("select Password from Advisor where NationalID='" + ID + "' ");
            ...
            {
                db.SqlDml("update Advisor set Password='" + txtNewPassword.Text + "' where NationalID='" + ID + "' ");
