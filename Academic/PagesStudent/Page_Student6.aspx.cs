...
{
    public partial class Page_Student6 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            tbl = db.SqlQuery("select Password from Student where NationalID='"+ID+"' ");
            ...
            {
                db.SqlDml("update Student set Password='" + txtNewPassword.Text + "' where NationalID='" + ID + "' ");
